...
namespace ProceduralMeshes.Streams
{
    ...
    {
        //four streams, one for each of the vertex attributes
        [NativeDisableContainerSafetyRestriction]
        NativeArray<float3> stream0, stream1; //position, normals

        [NativeDisableContainerSafetyRestriction]
        NativeArray<float4> stream2; //tangents

        [NativeDisableContainerSafetyRestriction]
        NativeArray<float2> stream3; //texcoord0
